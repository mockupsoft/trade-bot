...
class TestEdgeProofChecklist:
    def test_edge_proof_all_pass(self):
        ...
        assert result["passed"] == 11  # 10 original + 1 sample size
    ...
    def test_edge_proof_individual_failures(self, field, value, gate_name):
        ...
        base_metrics = {
            ...
            "expectancy_low_vol": 1.0,
            "expectancy_high_vol": 1.0,
            "expectancy_trending": 1.0,
            "positive_regime_count": 3,
            "tier_a_expectancy": 2.0,
            "tier_b_expectancy": 1.0,
            "tier_c_expectancy": 0.0,
            "tier_a_better_than_b": True,
            "tier_b_better_than_c": True,
            "smart_exit_pnl": 100.0,
            "flat_exit_pnl": 50.0,
    ...
    def test_edge_proof_boundaries(self):
        ...
        metrics_zero_exp = PerformanceMetrics(
        ...
        metrics_border_trades = PerformanceMetrics(
            expectancy_overall=1.0,
            expectancy_low_vol=5.0,
            expectancy_high_vol=10.0,
            expectancy_trending=20.0,
        ...
        metrics_just_below = PerformanceMetrics(
            expectancy_overall=1.0,
            expectancy_low_vol=5.0,
            expectancy_high_vol=10.0,
            expectancy_trending=20.0,
        ...
        metrics_zero_ms = PerformanceMetrics(
            expectancy_overall=1.0,
            expectancy_low_vol=5.0,
            expectancy_high_vol=10.0,
            expectancy_trending=20.0,
        ...
        metrics_fast = PerformanceMetrics(
            expectancy_overall=1.0,
            expectancy_low_vol=5.0,
            expectancy_high_vol=10.0,
            expectancy_trending=20.0,
