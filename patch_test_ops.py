filepath = 'tests/ops/test_ops.py'
with open(filepath, 'r') as f:
    content = f.read()

# Make base_* globals so they are accessible inside classes
...
content = content.replace("from cte.ops.kill_switch import OperationsController, TradingMode", "from cte.ops.kill_switch import OperationsController, TradingMode\n\n" + definitions)
